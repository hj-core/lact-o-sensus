...
### [ENG-03] Magic Number Avoidance

- **Target Scope**: All Source Files
- **Severity**: STYLE
- **DO**: Formalize configuration constants (such as timeout multipliers, connection cushions, or retry limits) in the configuration layer or as named constants.
- **DO NOT**: Use hardcoded numeric literals ("magic numbers") directly in orchestration or physical logic, as this reduces readability and makes the system's tuning opaque.
...
### [ENG-06] Async Function Discipline
