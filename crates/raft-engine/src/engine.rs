...
mod tests {
    ...
    mod storage_failure_isolation {
        ...
        impl LogStorage for FailingTermStorage {
        ...
        mod infallible_accessors {
            ...
            mod on_current_term {
                ...
                #[test]
                fn poisons_node_when_storage_fails() {
                    let fsm = Arc::new(MockFsm::default());
                    let storage = Arc::new(FailingTermStorage::new());
                    let thresholds = TickThresholds {
                        heartbeat_interval: TickDuration::new(10),
                        min_election: TickDuration::new(15),
                        max_election: TickDuration::new(30),
                    ...
                    let rng = StdRng::seed_from_u64(1);
                    let mut state =
                        LogicalNode::try_new(test_identity(1), fsm, storage, thresholds, rng)
                            .unwrap();
